...
public class UnsafeByteArrayOutputStream extends OutputStream {
     ...
     *
     * @see     UnsafeByteArrayOutputStream#count
     */
    public void reset() {
        count = 0;
    }
     ...
     * @see        UnsafeByteArrayOutputStream#size()
     * @see        UnsafeByteArrayOutputStream#toString(String)
     * @see        UnsafeByteArrayOutputStream#toString()
     */
    @Deprecated
