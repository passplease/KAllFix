//修改版的com.abdelaziz.canary.common.entity.CanaryEntityCollisions源码

package n1luik.KAllFix.fix.canary;
...
public class GcyrCanaryEntityCollisions {
                        ...
                        do {
                            if (this.index >= list.size()) {
                                ...
                                if (includeWorldBorder && !this.consumedWorldBorder) {
                                    ...
                                    WorldBorder worldBorder = MixinHelpers.modifySpaceStationBorder(entity.level.getWorldBorder(), entity);
    ...
    public static boolean doesEntityCollideWithWorldBorder(CollisionGetter collisionView, Entity entity) {
        if (isWithinWorldBorder(MixinHelpers.modifySpaceStationBorder(collisionView.getWorldBorder(), entity), entity.getBoundingBox())) {
            return false;
        } else {
    ...
    public static VoxelShape getWorldBorderCollision(CollisionGetter collisionView, Entity entity) {
        ...
        WorldBorder worldBorder = MixinHelpers.modifySpaceStationBorder(collisionView.getWorldBorder(), entity);
