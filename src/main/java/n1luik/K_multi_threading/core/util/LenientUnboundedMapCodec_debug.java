 ...
 */
public class LenientUnboundedMapCodec_debug<K, V> implements BaseMapCodec<K, V>, Codec<Map<K, V>>
{
    private final Codec<K> keyCodec;
    private final Codec<V> elementCodec;

    public LenientUnboundedMapCodec_debug(final Codec<K> keyCodec, final Codec<V> elementCodec) {
    ...
    public <T> DataResult<Map<K, V>> decode(DynamicOps<T> ops, MapLike<T> input)
    {
        ...
        final DataResult<Unit> result = input.entries().reduce(
                ...
                (r, pair) -> {
                    ...
                    v.get().map(v2->v2, e->{
                        System.out.println("LenientUnboundedMapCodec_debug 1" +e.message());
                        return null;
                    });
    ...
    public boolean equals(final Object o) {
        ...
        final LenientUnboundedMapCodec_debug<?, ?> that = (LenientUnboundedMapCodec_debug<?, ?>) o;
