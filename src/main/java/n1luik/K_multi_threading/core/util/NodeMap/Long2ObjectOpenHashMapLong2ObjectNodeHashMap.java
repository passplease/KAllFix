...
public class Long2ObjectOpenHashMapLong2ObjectNodeHashMap<V> extends Long2ObjectOpenHashMap<V> {
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Entry<V>> implements FastEntrySet<V> {
        ...
        @Override
        public void clear() {
            Long2ObjectOpenHashMapLong2ObjectNodeHashMap.this.clear();
        }
         ...
         */
        @Override
        public ObjectListIterator<Entry<V>> fastIterator() {
            throw new UnsupportedOperationException();
        }
