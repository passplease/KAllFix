...
public class Reference2ObjectMapAVLTreeMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements java.io.Serializable, Cloneable {
     ...
     */
    public Reference2ObjectMapAVLTreeMap() {
        tree = null;
        count = 0;
    }
     ...
     */
    public Reference2ObjectMapAVLTreeMap(final Comparator<? super K> c) {
        this();
        storedComparator = c;
        setActualComparator();
    }
     ...
     */
    public Reference2ObjectMapAVLTreeMap(final Map<? extends K, ? extends V> m) {
        this();
        putAll(m);
    }
     ...
     */
    public Reference2ObjectMapAVLTreeMap(final SortedMap<K, V> m) {
        this(m.comparator());
        putAll(m);
    }
     ...
     */
    public Reference2ObjectMapAVLTreeMap(final Object2ObjectMap<? extends K, ? extends V> m) {
        this();
        putAll(m);
    }
     ...
     */
    public Reference2ObjectMapAVLTreeMap(final Object2ObjectSortedMap<K, V> m) {
        this(m.comparator());
        putAll(m);
    }
     ...
     */
    public Reference2ObjectMapAVLTreeMap(final K[] k, final V v[], final Comparator<? super K> c) {
        this(c);
     ...
     * @throws IllegalArgumentException if {@code k} and {@code v} have different lengths.
     */
    public Reference2ObjectMapAVLTreeMap(final K[] k, final V v[]) {
        this(k, v, null);
    }
    ...
    */
    ...
    private class TreeIterator {
        ...
        public void remove() {
            ...
            updatePrevious();
            updateNext();
            Reference2ObjectMapAVLTreeMap.this.remove(curr.key);
            curr = null;
        }
    ...
    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
        if (entries == null) entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
            final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = (Reference2ObjectMapAVLTreeMap.this.actualComparator == null ? (Comparator<Object2ObjectMap.Entry<K, V>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2ObjectMap.Entry<K, V>>)(x, y) -> Reference2ObjectMapAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
    ...
    private final class Submap extends AbstractObject2ObjectSortedMap<K, V> implements java.io.Serializable {
        ...
        @Override
        public void clear() {
            final Submap.SubmapIterator i = new Submap.SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
            if (entries == null) entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
                ...
                @Override
                public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(final Object2ObjectMap.Entry<K, V> from) {
                    return new Submap.SubmapEntryIterator(from.getKey());
                }
                ...
                @Override
                public boolean isEmpty() {
                    return !new Submap.SubmapIterator().hasNext();
                }
        ...
        private class KeySet extends AbstractObject2ObjectSortedMap<K, V>.KeySet {
            ...
            @Override
            public ObjectBidirectionalIterator<K> iterator(final K from) {
                return new Submap.SubmapKeyIterator(from);
            }
        }

        @Override
        public ObjectSortedSet<K> keySet() {
            if (keys == null) keys = new Submap.KeySet();
            return keys;
        }
        ...
        @SuppressWarnings("unchecked")
        public V get(final Object k) {
            final Reference2ObjectMapAVLTreeMap.Entry<K, V> e;
            final K kk = (K)k;
         ...
         */
        public Reference2ObjectMapAVLTreeMap.Entry<K, V> firstEntry() {
            if (tree == null) return null;
            // If this submap goes to -infinity, we return the main map first entry; otherwise, we locate the
            // start of the map.
            Reference2ObjectMapAVLTreeMap.Entry<K, V> e;
         ...
         */
        public Reference2ObjectMapAVLTreeMap.Entry<K, V> lastEntry() {
            if (tree == null) return null;
        ...
        private class SubmapEntryIterator extends Submap.SubmapIterator implements ObjectListIterator<Object2ObjectMap.Entry<K, V>> {
            SubmapEntryIterator() {
            }
         ...
         * entries.
         */
        private final class SubmapKeyIterator extends Submap.SubmapIterator implements ObjectListIterator<K> {
         ...
         * possibly their type-specific counterparts) so that they return values instead of entries.
         */
        private final class SubmapValueIterator extends Submap.SubmapIterator implements ObjectListIterator<V> {
            @Override
            public V next() {
                return nextEntry().value;
            }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public Reference2ObjectMapAVLTreeMap<K, V> clone() {
        Reference2ObjectMapAVLTreeMap<K, V> c;
        try {
            c = (Reference2ObjectMapAVLTreeMap<K, V>)super.clone();
        } catch (CloneNotSupportedException cantHappen) {
            throw new InternalError();
        }
        c.keys = null;
