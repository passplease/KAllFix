...
public class OpenFalseAbstractReferenceSortedSet<T> extends AbstractReferenceSortedSet<T> {
    protected final Set<T> backing;

    public OpenFalseAbstractReferenceSortedSet(Set<T> backing) {
    ...
    @Override
    public ReferenceSortedSet<T> subSet(T fromElement, T toElement) {
        throw new UnsupportedOperationException();
    }

    @Override
    public ReferenceSortedSet<T> headSet(T toElement) {
        throw new UnsupportedOperationException();
    }

    @Override
    public ReferenceSortedSet<T> tailSet(T fromElement) {
        throw new UnsupportedOperationException();
    }
