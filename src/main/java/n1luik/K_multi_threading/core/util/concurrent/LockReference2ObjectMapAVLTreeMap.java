...
public class LockReference2ObjectMapAVLTreeMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements java.io.Serializable, Cloneable {
     ...
     */
    public LockReference2ObjectMapAVLTreeMap() {
        tree = null;
        count = 0;
    }
     ...
     */
    public LockReference2ObjectMapAVLTreeMap(final Comparator<? super K> c) {
        this();
        storedComparator = c;
        setActualComparator();
    }
     ...
     */
    public LockReference2ObjectMapAVLTreeMap(final Map<? extends K, ? extends V> m) {
        this();
        putAll(m);
    }
     ...
     */
    public LockReference2ObjectMapAVLTreeMap(final SortedMap<K, V> m) {
        this(m.comparator());
        putAll(m);
    }
     ...
     */
    public LockReference2ObjectMapAVLTreeMap(final Object2ObjectMap<? extends K, ? extends V> m) {
        this();
        putAll(m);
    }
     ...
     */
    public LockReference2ObjectMapAVLTreeMap(final Object2ObjectSortedMap<K, V> m) {
        this(m.comparator());
        putAll(m);
    }
     ...
     */
    public LockReference2ObjectMapAVLTreeMap(final K[] k, final V v[], final Comparator<? super K> c) {
        this(c);
     ...
     * @throws IllegalArgumentException if {@code k} and {@code v} have different lengths.
     */
    public LockReference2ObjectMapAVLTreeMap(final K[] k, final V v[]) {
        this(k, v, null);
    }
    ...
    */
    ...
    private class TreeIterator {
        ...
        LockReference2ObjectMapAVLTreeMap.Entry<K, V> previousEntry() {
        ...
        public void remove() {
            synchronized (LockReference2ObjectMapAVLTreeMap.this){
			...
			/* If the last operation was a next(), we are removing an entry that preceeds
                ...
                updatePrevious();
                updateNext();
                LockReference2ObjectMapAVLTreeMap.this.remove(curr.key);
                curr = null;
            }
        }
    ...
    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
        if (entries == null) entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
            final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = (LockReference2ObjectMapAVLTreeMap.this.actualComparator == null ? (Comparator<Object2ObjectMap.Entry<K, V>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2ObjectMap.Entry<K, V>>)(x, y) -> LockReference2ObjectMapAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
    ...
    private final class Submap extends AbstractObject2ObjectSortedMap<K, V> implements java.io.Serializable {
        ...
        public ObjectSortedSet<Entry<K, V>> object2ObjectEntrySet() {
            if (entries == null) entries = new AbstractObjectSortedSet<Entry<K, V>>() {
                ...
                public ObjectBidirectionalIterator<Entry<K, V>> iterator() {
                    return new LockReference2ObjectMapAVLTreeMap.Submap.SubmapEntryIterator();
                }

                @Override
                public ObjectBidirectionalIterator<Entry<K, V>> iterator(final Entry<K, V> from) {
                    return new LockReference2ObjectMapAVLTreeMap.Submap.SubmapEntryIterator(from.getKey());
                }
                ...
                public boolean remove(final Object o) {
                    ...
                    synchronized (LockReference2ObjectMapAVLTreeMap.this){
                        final Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
                        final var f = findKey(((K) e.getKey()));
                        if (f != null && in(f.key)) LockReference2ObjectMapAVLTreeMap.Submap.this.remove(f.key);
                        return f != null;
                    }
                }
                ...
                @Override
                public boolean isEmpty() {
                    return !new LockReference2ObjectMapAVLTreeMap.Submap.SubmapIterator().hasNext();
                }

                @Override
                public void clear() {
                    LockReference2ObjectMapAVLTreeMap.Submap.this.clear();
                }
        ...
        private class KeySet extends AbstractObject2ObjectSortedMap<K, V>.KeySet {
            @Override
            public ObjectBidirectionalIterator<K> iterator() {
                return new LockReference2ObjectMapAVLTreeMap.Submap.SubmapKeyIterator();
            }

            @Override
            public ObjectBidirectionalIterator<K> iterator(final K from) {
                return new LockReference2ObjectMapAVLTreeMap.Submap.SubmapKeyIterator(from);
            }
        }
        ...
        public ObjectCollection<V> values() {
            if (values == null) values = new AbstractObjectCollection<V>() {
                @Override
                public ObjectIterator<V> iterator() {
                    return new LockReference2ObjectMapAVLTreeMap.Submap.SubmapValueIterator();
                }
                ...
                @Override
                public int size() {
                    return LockReference2ObjectMapAVLTreeMap.Submap.this.size();
                }
        ...
        @SuppressWarnings("unchecked")
        public V get(final Object k) {
            final LockReference2ObjectMapAVLTreeMap.Entry<K, V> e;
            final K kk = (K)k;
         ...
         */
        public LockReference2ObjectMapAVLTreeMap.Entry<K, V> firstEntry() {
            if (tree == null) return null;
            // If this submap goes to -infinity, we return the main map first entry; otherwise, we locate the
            // start of the map.
            LockReference2ObjectMapAVLTreeMap.Entry<K, V> e;
         ...
         */
        public LockReference2ObjectMapAVLTreeMap.Entry<K, V> lastEntry() {
            if (tree == null) return null;
        ...
        private class SubmapEntryIterator extends LockReference2ObjectMapAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Entry<K, V>> {
            SubmapEntryIterator() {
            }
         ...
         * entries.
         */
        private final class SubmapKeyIterator extends LockReference2ObjectMapAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<K> {
         ...
         * possibly their type-specific counterparts) so that they return values instead of entries.
         */
        private final class SubmapValueIterator extends LockReference2ObjectMapAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<V> {
            @Override
            public V next() {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public synchronized LockReference2ObjectMapAVLTreeMap<K, V> clone() {
        LockReference2ObjectMapAVLTreeMap<K, V> c;
        try {
            c = (LockReference2ObjectMapAVLTreeMap<K, V>)super.clone();
        } catch (CloneNotSupportedException cantHappen) {
            throw new InternalError();
        }
        c.keys = null;
