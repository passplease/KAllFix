...
public class CreateTrackBlockSynchronized_Asm implements ITransformer<ClassNode> {
    @NotNull
    @Override
        ...
        for (MethodNode method : input.methods) {
            if (method.name.equals("m_213897_")){
                ...
                for (AbstractInsnNode instruction : instructions) {
                    ...
                    if (!add1 && instruction.getOpcode() == Opcodes.INVOKESTATIC && instruction instanceof MethodInsnNode methodInsnNode
                                && methodInsnNode.owner.equals("com/simibubi/create/content/trains/track/TrackPropagator")
                                && methodInsnNode.name.equals("onRailAdded")
                        ) {
    ...
    public @NotNull Set<Target> targets() {
        return Set.of(
                Target.targetClass("com/simibubi/create/content/trains/track/TrackBlock"));
    }
}
