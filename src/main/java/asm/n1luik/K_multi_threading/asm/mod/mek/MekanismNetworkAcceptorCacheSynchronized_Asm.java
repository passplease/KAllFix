    ...
    public ClassNode transform(ClassNode input, ITransformerVotingContext context) {
        ...
        if (input.name.equals("mekanism/common/lib/transmitter/acceptor/NetworkAcceptorCache")){
            for (MethodNode method : input.methods) {
                if ((method.name.equals("adoptAcceptors") && method.desc.equals("(Lmekanism/common/lib/transmitter/acceptor/NetworkAcceptorCache;)V"))){
                    debug_add1 = true;
...
//                    }
        ...
        if (!debug_add1){
            throw new RuntimeException("Not mapping error: mekanism/common/lib/transmitter/acceptor/NetworkAcceptorCache");
        }
