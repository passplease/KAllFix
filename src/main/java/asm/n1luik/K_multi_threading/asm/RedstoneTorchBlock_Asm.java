...
@Deprecated
public class RedstoneTorchBlock_Asm extends ITransformer2{
    @NotNull
    @Override
            ...
            if (method.name.equals("<init>")) {
                ...
                for (AbstractInsnNode instruction : instructions) {
                    if (instruction.getOpcode() == Opcodes.INVOKESPECIAL && instruction instanceof MethodInsnNode methodInsnNode) {
                        if (methodInsnNode.owner.equals("java/util/WeakHashMap")) {
                            if (methodInsnNode.name.equals("<init>") && methodInsnNode.desc.equals("()V")) {
                                method.instructions.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "n1luik/K_multi_threading/core/util/concurrent/LockIdentityHashMap", "<init>", "()V", false));
                            } else {
                        ...
                        if (typeInsnNode.desc.equals("java/util/WeakHashMap")) {
