...
public class AddSynchronized_Asm extends ITransformer2 {
    public final List<String[]> stringsList = new ArrayList<>(List.of(
            ...
            ////////
            ForgeAsm.minecraft_map.mapMethod("net/minecraft/world/level/block/RedstoneTorchBlock.tick(Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/server/level/ServerLevel;Lnet/minecraft/core/BlockPos;Lnet/minecraft/util/RandomSource;)V"),
            ForgeAsm.minecraft_map.mapMethod("net/neoforged/neoforge/capabilities/CapabilityListenerHolder.addListener(Lnet/minecraft/core/BlockPos;Lnet/neoforged/neoforge/capabilities/ICapabilityInvalidationListener;)V"),
            ...
            ForgeAsm.minecraft_map.mapMethod("net/minecraft/server/level/ThreadedLevelLightEngine.runUpdate()V"),
