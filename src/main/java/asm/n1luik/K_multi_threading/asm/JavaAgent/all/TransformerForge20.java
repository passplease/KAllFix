...
public class TransformerForge20 extends ITransformer2 {
    ...
    public ClassNode transform(ClassNode input) {
        try {
            ...
            AsmUtil.replaceMethodName(input, Forge20Asm.class.getMethod("streamServiceLoader", Supplier.class, Consumer.class), "streamServiceLoader", null);
            AsmUtil.replaceMethodName(input, Forge20Asm.class.getMethod("load", ModuleLayer.class, Class.class), "load", "java/util/ServiceLoader");
